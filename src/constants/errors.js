export const ERRORS = {
    ...
    MISSING_INVALID_TOKEN: { message: "Missing or Invalid Token.", code: "ERR_012", status: 401 },
    INVALID_EXPIRED_LINK_TOKEN: { message: "The Link is invalid or has already expired.", code: "ERR_013", status: 401 },
